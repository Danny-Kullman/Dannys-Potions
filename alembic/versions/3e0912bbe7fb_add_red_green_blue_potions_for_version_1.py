...
Revision ID: 3e0912bbe7fb
Revises: e91d0c24f7d0
Create Date: 2026-04-01 13:50:44.858659
...
def upgrade():
    op.add_column(
        "global_inventory",
        sa.Column(
            "max_barrel_capacity", sa.Integer(), nullable=False, server_default="10000"
        ),
    )
    op.add_column(
        "global_inventory",
        sa.Column(
            "max_potion_capacity", sa.Integer(), nullable=False, server_default="50"
        ),
    )
    op.add_column(
        "global_inventory",
    ...
    op.add_column(
        "global_inventory",
        sa.Column("dark_potions", sa.Integer(), nullable=False, server_default="0"),
    )
    ...
    op.create_check_constraint(
        "ck_dark_potions_non_negative", "global_inventory", "dark_potions >= 0"
    )
...
def downgrade():
    ...
    op.drop_constraint(
        "ck_dark_potions_non_negative", "global_inventory", type_="check"
    )
